...
const TourSchema = new Schema({
    ...
    featuredImage: { type: String }, // Featured/representative image
...
// Function to generate slug from title (rút ngắn để SEO tốt hơn)
function generateSlug(title) {
    return title
        ...
        .replace(/-+/g, '-')
        .replace(/^-|-$/g, '')
        // Rút ngắn slug để dễ đọc và SEO tốt hơn (tối đa 50 ký tự)
        .substring(0, 50)
        .replace(/-+$/, ''); // Loại bỏ dấu gạch ngang ở cuối nếu bị cắt
}
