...
router.post("/add", checkPermission("CREATE_TOUR"), uploadToCloudinaryGeneral.fields([
...
router.post( "/edit/:id", checkPermission("UPDATE_TOUR"), uploadToCloudinaryGeneral.fields([
    { name: 'featuredImage', maxCount: 1 },
    { name: 'images', maxCount: 10 }
]), controller.update );
