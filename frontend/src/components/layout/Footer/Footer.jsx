    ...
    <footer className="footer">
      ...
      <div className="footer__bottom">
        <div className="footer__copyright">
          <div>Copyright © 2011-2025. All Rights Reserved by ND Travel</div>
          <div style={{ fontSize: '0.85em', marginTop: '4px', opacity: 0.8 }}>
            Phần mềm được phát triển bởi Kiều Đạt |
            <a href="/ban-quyen-hinh-anh" style={{ marginLeft: '4px', color: 'inherit', textDecoration: 'underline' }}>
              Bản quyền phần mềm
            </a>
          </div>
        </div>
